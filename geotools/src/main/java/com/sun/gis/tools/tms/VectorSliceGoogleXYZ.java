...
/**
 * shapefile文件数据切片-GoogleXYZ格式
 * shapefile文件数据坐标系必须为3857
 */
public class VectorSliceGoogleXYZ {
        ...
        try {
            ...
            for (int y = 0; y < numTiles; y++) {
                for (int x = 0; x < numTiles; x++) {
                    ...
                    double tileMinY = dataMinY + (y) * dataHeight / numTiles;
                    double tileMaxY = dataMinY + (y + 1) * dataHeight / numTiles;
...
//        LineSymbolizer lineSymbolizer = styleFactory.createLineSymbolizer(stroke, null);
    ...
    public static void main(String[] args) throws IOException, FactoryException, TransformException {
        ...
        String outputDir = "D:\\code\\github\\gis-server\\data\\output\\VectorSliceGoogleXYZ";
